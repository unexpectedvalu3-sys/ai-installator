...
<!-- PWA : installable comme une app (Android + iOS). Le manifest et le SW ne
     sont servis qu'en mode HTTP (backend) ; en file:// ces liens sont inertes. -->
<meta name="theme-color" content="#0E1C19">
<link rel="manifest" href="/manifest.webmanifest">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="KinéCotation">
...
// Uniquement en mode SERVI (http/https) : en file:// il n'y a pas de SW.
// Non bloquant (apres load) ; echec silencieux (l'app marche sans).
